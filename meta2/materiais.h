...
GLfloat vidroAmb[] = { 1.0f, 1.0f, 1.0f, 0.5f, 1.0f };
GLfloat vidroDif[] = { 1.00f, 1.00f, 1.00f, 0.5f, 0.035f };
GLfloat vidroSpec[] = { 0.80f, 0.80f, 0.80f, 0.5f, 1.0f };
GLfloat vidroCoef =  0.25 * 128 ;
